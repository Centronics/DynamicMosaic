...
namespace DynamicMosaicTest
{
    ...
    public class ReflectorTest
    {
        ...
        public void ReflectorTest2()
        {
            ...
            Assert.AreEqual(true, reflector.FindRelation(main, "AB", 1));
            Assert.AreEqual(true, reflector.FindRelation(main, "BA", 1));
            Assert.AreEqual(false, reflector.FindRelation(main, "AA", 1));
            Assert.AreEqual(false, reflector.FindRelation(main, "BB", 1));
            Assert.AreEqual(true, reflector.FindRelation(main, "AAA", 1));
