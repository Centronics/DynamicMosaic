...
namespace DynamicMosaic
{
    ...
    public sealed class DynamicReflex
    {
        ...
        /// <summary>
        ///     Получает карты, позволяющие выполнить поиск требуемого слова, т.е. искомое слово можно
        ...
        ///     Если увеличение было произведено, метод возвращает номер позиции, на которой произошло изменение, в противном случае
        ///     -1.
        /// </summary>
