...
namespace DynamicMosaic
{
    ...
    public sealed class ProcessorHandler
    {
        ...
        /// </returns>
        /// <remarks>
        /// Рекомендуется, чтобы значения свойств <see cref="Processor.Tag"/> подаваемых на вход карт, состояли из одной заглавной буквы, т.к. остальные буквы будут отброшены в любом случае.
